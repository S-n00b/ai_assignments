...
from src.model_evaluation import ComprehensiveEvaluationPipeline, ModelConfig
from src.ai_architecture import HybridAIPlatform, ModelLifecycleManager
...
class TestDataScientistScenarios:
    ...
    async def test_data_scientist_model_comparison_scenario(self, data_scientist_setup, sample_evaluation_data, mock_api_client):
        ...
        with patch('src.gradio_app.create_gradio_app') as mock_app:
